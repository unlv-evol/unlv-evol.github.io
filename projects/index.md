...
<main id="top">
  <section>
    <div class="wrap">
      ...
      {% include project-cards.html mode='catalog' %}

      <div class="projects-cta">
        <p> Return to the home page for the shorter overview.</p>
        <a class="btn btn-outline" href="{{ '/#projects' | relative_url }}">Back to selected projects</a>
      </div>
    </div>
  </section>
</main>
